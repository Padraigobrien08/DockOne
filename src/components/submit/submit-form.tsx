        ...
        <div className="mb-8 flex gap-2">
          <span
            className={`rounded-full px-3 py-1 text-sm font-medium ${
              step >= 1 ? "bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900" : "bg-zinc-200 text-zinc-600 dark:bg-zinc-700 dark:text-zinc-400"
            }`}
          >
            1. Basics
          </span>
          <span
            className={`rounded-full px-3 py-1 text-sm font-medium ${
              step >= 2 ? "bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900" : "bg-zinc-200 text-zinc-600 dark:bg-zinc-700 dark:text-zinc-400"
            }`}
          >
            2. Description & media
          </span>
        ...
        {step === 2 && (
          <form action={formAction} className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">Max 10,000 characters.</p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">JPEG, PNG or WebP. Max 5MB each.</p>
            </div>
